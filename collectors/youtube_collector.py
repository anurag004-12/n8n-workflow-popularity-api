...
from config import PLACEHOLDER_YOUTUBE_API_KEY
...
def get_youtube_client():
    ...
    if not api_key or api_key == PLACEHOLDER_YOUTUBE_API_KEY:
        raise RuntimeError(
            "YOUTUBE_API_KEY is not configured. Add a valid key to .env."
        )
